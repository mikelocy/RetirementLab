    ...
    <Box sx={{ mt: 3 }}>
      ...
      >
        ...
        >
          <TableHead>
            <TableRow>
              <TableCell sx={{ position: 'sticky', left: 0, backgroundColor: 'white', zIndex: 3, fontWeight: 'bold', width: 200, minWidth: 200 }}>
                Category
              </TableCell>
              {data.ages.map((age) => (
                <TableCell key={age} align="right" sx={{ minWidth: 100 }}>
                  Age {age}
                </TableCell>
              ))}
            </TableRow>
          ...
          <TableBody>
            ...
            <TableRow>
              <TableCell sx={{ pl: 2, fontWeight: 'bold', position: 'sticky', left: 0, backgroundColor: '#e3f2fd', zIndex: 2 }}>
                Total Assets
              </TableCell>
            ...
            {debtIds.length > 0 && (
              <>
                ...
                <TableRow>
                  <TableCell sx={{ pl: 2, fontWeight: 'bold', position: 'sticky', left: 0, backgroundColor: '#ffebee', zIndex: 2 }}>
                    Total Debts
                  </TableCell>
            ...
            <TableRow>
              <TableCell sx={{ pl: 2, fontWeight: 'bold', position: 'sticky', left: 0, backgroundColor: '#e8f5e9', zIndex: 2 }}>
                Net Worth
              </TableCell>
            ...
            <TableRow>
              <TableCell sx={{ pl: 2, fontWeight: 'bold', position: 'sticky', left: 0, backgroundColor: '#fff3e0', zIndex: 2 }}>
                Total Income
              </TableCell>
